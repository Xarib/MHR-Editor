...
public class Horn : IGameData, IAttack, ICriticalRate, IDefenseBonus, IRampageSlots, ISharpness, ISlots, IWeaponElement, IRarity, IName
{
    [JsonIgnore]
    ...
    public IList<Snow_data_DataDef_HornConcertId> MelodyEffects { get; set; }
}