...
public class SlashAxe : IGameData, IAttack, ICriticalRate, IDefenseBonus, IRampageSlots, ISharpness, ISlots, IWeaponElement, IRarity, IName
{
    [JsonIgnore]
    ...
    public Snow_data_SlashAxeWeaponBaseData_BottleTypes PhialType { get; set; }
    public int PhialElement { get; set; }
}